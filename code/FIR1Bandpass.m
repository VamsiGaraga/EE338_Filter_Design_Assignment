...
n = (2*N_min + 1) + 18;% By trail and error method, we increase n
              %least n satisfying all the conditions was 69, i.e. (2*N_min
              %+ 1) + 18
...
fvtool(FIR_BandPass);         %Magnitude and Phase response in normalized domain
